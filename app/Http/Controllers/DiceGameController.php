...
class DiceGameController extends Controller
{
    ...
    // {
    //     $diceRoll1 = 'storage/dice/dice-six-faces-' . rand(1, 6) . '.png';
    //     $diceRoll2 = 'storage/dice/dice-six-faces-' . rand(1, 6) . '.png';
    //     $diceRoll3 = 'storage/dice/dice-six-faces-' . rand(1, 6) . '.png';
    //     $diceRoll4 = 'storage/dice/dice-six-faces-' . rand(1, 6) . '.png';
    //     $diceRoll5 = 'storage/dice/dice-six-faces-' . rand(1, 6) . '.png';

    //     $diceRoll = [$diceRoll1, $diceRoll2, $diceRoll3, $diceRoll4, $diceRoll5];

    //     return view('dice-game.index', ['diceRoll' => $diceRoll]);
    // }
    ...
    //     // Calculate score for specific combinations
    //     if (array_values($counts) === [1, 1, 1, 1, 1]) {
    //         if (in_array(1, $diceRolls) && in_array(5, $diceRolls)) {
    //             $score += 125;
    //         } elseif (in_array(2, $diceRolls) && in_array(6, $diceRolls)) {
    //             $score += 250;
    //         }
    //     }
